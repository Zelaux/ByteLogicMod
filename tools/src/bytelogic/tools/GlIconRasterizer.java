...
public class GlIconRasterizer{
    ...
    public static void main(String[] inputArgs){
        try{
            ...
            Log.warn("Cannot run " + GlIconRasterizer.class.getSimpleName() + ", reason: @", Strings.getStackTrace(error));
...
//                dst.copyTo(iconsPartFolder.child(dst.name()));
                ...
                for(int size : sizes){
                    new GlIconRasterizer().convert(new Pixmap(img), size, svgOutputFolder.child(fileName + "-" + size + ".png"));
...
//        output.writeString(out.toString());
    ...
    private void marchingSquere(Pixmap pixmap){
